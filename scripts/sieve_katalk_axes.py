...
kat = [
    # 근력-2%: 기록 직접 4659919 는 오기 — avg 항등식(전투력=floor((직+소)/2))으로
    #   직접 = 4658919(±1) 복원. 복원 후 표시 가설 예측 4610.5 vs 실측 4611 (±0.5 BP)
    #   → cross = 표시 주스탯 확정, 기본(raw) 가설은 980 BP 이탈 기각.
    ('근력-2%',    27086, 0, 0, 0, bd - 4658919, bs - 4882971),
    # 근마-2pp 제외 — 잔여 0.063% 긴장 (g 표시 소수 의심, disp/raw 와는 별개 문제)
