...
// V_BIG2 학습 결과 (51건, D_pen 고정, RMSE 0.94%)
// K0/K1/K2/base는 함께 절충되어 큰/작은 값으로 수렴 (비율은 자연스러움: K1/K0 ≈ 97)
...
export const PHYSICAL_PARAMS = Object.freeze({
  K0: 7.76845770e-1,       // 주스탯 가중치
  K1: 7.56299671e+1,       // 공격력 가중치 (K1/K0 ≈ 97.4)
  K2: 9.49018298e-1,       // 고댐 가중치 (K2/K0 ≈ 1.22)
  D_crit: 1.28001114e+2,   // 크댐 분모 (≈128.0)
  D_dmg: 1.21202369e-12,   // (최소뎀+최대뎀) 분모 (수렴값, base와 함께 비율로만 의미)
  D_dom: 2.17039905e+2,    // 지배력 분모 (≈217.0)
  K_geunma: 8.28855077e-4, // 근마효율 계수 (≈0.000829)
  D_pen: 25.0,             // 관통 분모 (고정, 3 페어로 검증 — 관통 1당 ≈+0.81%)
  base: 4.56687744e-20,    // 전체 보정 상수
});
