...
export const PHYSICAL_PARAMS = Object.freeze({
  K0: 3.12927507e+0,       // 주스탯 가중치
  K1: 3.05925278e+2,       // 공격력 가중치 (K1/K0 ≈ 97.8)
  K2: 3.34429725e+0,       // 고댐 가중치 (K2/K0 ≈ 1.07)
  D_crit: 2.22057939e+2,   // 크댐 분모 (≈222.1)
  D_dmg: 2.79060837e-13,   // (최소뎀+최대뎀) 분모 (수렴값, base와 함께 비율로만 의미)
  D_dom: 2.12922889e+2,    // 지배력 분모 (≈212.9)
  K_geunma: 8.18473267e-4, // 근마효율 계수 (≈0.000818)
  D_pen: 25.2,             // 관통 분모 (고정, 페어 데이터로 도출 — 관통 1당 ≈+0.81%)
  base: 4.51674529e-21,    // 전체 보정 상수
});
